...
/*
* Multi-threaded test program which performs more writes than reads
*
*/
...
void* more_writes_function(void* id) {                                                                                                                                                                                                       
...
void run_more_writes_test() { 
    ...
    for (int i = 0; i < NUM_THREADS; ++i) {
        ...
        if (pthread_create(&threads[i], NULL, more_writes_function, (void*)&thread_ids[i])) {
