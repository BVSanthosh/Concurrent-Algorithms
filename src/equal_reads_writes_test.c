...
/*
* Multi-threaded test program which performs equal number of reads and writes
*
*/
...
void* equal_reads_writes_test_function(void* id) {                                                                                                                                                                                                       
...
void run_equal_reads_writes_test() { 
    ...
    for (int i = 0; i < NUM_THREADS; ++i) {
        ...
        if (pthread_create(&threads[i], NULL, equal_reads_writes_test_function, (void*)&thread_ids[i])) {
